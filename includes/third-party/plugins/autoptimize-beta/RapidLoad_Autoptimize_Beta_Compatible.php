...
if(class_exists('RapidLoad_Autoptimize_Beta_Compatible')){
    return;
}

class RapidLoad_Autoptimize_Beta_Compatible extends RapidLoad_ThirdParty {
    ...
    public function rapidload_init_hooks(){
        ...
        add_action('uucss/options/before_render_form', [$this, 'rapidload_render_option_page_ao_admin_tabs']);

        add_filter( 'autoptimize_filter_settingsscreen_tabs', [$this, 'rapidload_handle'], 20, 1 );

        add_filter('uucss/notifications', [$this, 'rapidload_addNotifications'], 10, 1);
    ...
    public function rapidload_addNotifications($notifications) {
    ...
    public function rapidload_get_node_text() {
        ob_start();
    ...
    public function rapidload_render_option_page_ao_admin_tabs(){
