...
class RapidLoad_Image_Enqueue
{
    ...
    function handle_youtube_iframe($iframe, $src) {
        ...
        if ($video_poster) {
            ...
            $iframe_content_styles = apply_filters('rapidload/enqueue/iframe/content/styles', [
                'position' => 'relative',
                'top' => '0',
                'left' => '0',
                'width' => '100%',
